...
export default function LifeCareerTab({ form, set }: { form: Pick<ProfileForm, "occupation" | "yearsInOccupation" | "education" | "maritalStatus" | "divorced" | "kids" | "homePaidOff">; set: SetField }) {
  return (
